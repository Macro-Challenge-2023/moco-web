            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="pt-32 pb-12 md:pt-40 md:pb-20 text-white">
                    <div className="mx-auto lg:mx-0">
                        ...
                        <p className="mt-2 text-lg">We use Your Personal data to provide and improve the Service. By using the
                        ...
                        <ul className="text-lg">
                            ...
                            <li><strong>Application</strong> refers to Moco, the software program provided by the
                                Company.</li>
                            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                                Agreement) refers to Moco.</li>
                            ...
                            <li><strong>You</strong> means the individual accessing or using the Service, or the company,
                        ...
                        <p className="mt-2 text-lg">When You access the Service by or through a mobile device, We may collect
                        ...
                        <p className="mt-2 text-lg">We may also collect information that Your browser sends whenever You visit our
                        ...
                        <p className="mt-2 text-lg">The Company will also retain Usage Data for internal analysis purposes. Usage
                        ...
                        <p className="mt-2 text-lg">Your consent to this Privacy Policy followed by Your submission of such
                            information represents Your agreement to that transfer.</p>
                        <p className="mt-2 text-lg">The Company will take all steps reasonably necessary to ensure that Your data is
                        ...
                        <h2 id="delete-your-personal-data" className="font-bold tracking-tight sm:text-2xl mt-6">Delete Your Personal Data</h2>
                        <p className="mt-2 text-lg">You have the right to delete or request that We assist in deleting the Personal
                            Data that We have collected about You.</p>
                        <p className="mt-2 text-lg">Our Service may give You the ability to delete certain information about You
                            from within the Service.</p>
                        <p className="mt-2 text-lg">You may update, amend, or delete Your information at any time by signing in to
                            ...
                            provided to Us.</p>
                        <p className="mt-2 text-lg">Please note, however, that We may need to retain certain information when we
                            have a legal obligation or lawful basis to do so.</p>


                        <h2 id="disclosure-of-your-personal-data" className="font-bold tracking-tight sm:text-2xl mt-6">Disclosure of Your Personal Data</h2>
                        <h2 id="business-transactions" className="font-bold tracking-tight sm:text-2xl mt-6">Business Transactions</h2>
                        <p className="mt-2 text-lg">If the Company is involved in a merger, acquisition or asset sale, Your Personal
                        ...
                        <h2 id="law-enforcement" className="font-bold tracking-tight sm:text-2xl mt-6">Law Enforcement</h2>
                        <p className="mt-2 text-lg">Under certain circumstances, the Company may be required to disclose Your
                            Personal Data if required to do so by law or in response to valid requests by
                            public authorities (e.g. a court or a government agency).</p>

                        <h2 id="other-legal-requirements" className="font-bold tracking-tight sm:text-2xl mt-6">Other legal requirements</h2>
                        ...
                        <h2 id="security-of-your-personal-data" className="font-bold tracking-tight sm:text-2xl mt-6">Security of Your Personal Data</h2>
                        <h2 id="childrens-privacy" className="font-bold tracking-tight sm:text-3xl mt-6">Children's Privacy</h2>
                        <p className="mt-2 text-lg">Our Service does not address anyone under the age of 13. We do not knowingly
                        ...
                        <p className="mt-2 text-lg">If We need to rely on consent as a legal basis for processing Your information
                            and Your country requires consent from a parent, We may require Your parent's
                            consent before We collect and use that information.</p>


                        <h2 id="links-to-other-websites" className="font-bold tracking-tight sm:text-3xl mt-6">Links To Other Websites</h2>

                        <p className="mt-2 text-lg">Our Service may contain links to other websites that are not operated by Us. If
                        ...
                        <p className="mt-2 text-lg">You are advised to review this Privacy Policy periodically for any changes.
